...
const Tooltip = ({
  ...
  const computePosition = () => {
    ...
    const { scrollWidth: bodyScrollWidth, scrollHeight: bodyScrollHeight } =
      document.body
        ...
        {isVisible && (
          <div
            ...
            className={`tooltipContent ${
              location ? location : tooltipPosition
            }`}
          ...
          >
            ...
            <div className="align-center">
              ...
              <Button
                variant="contained"
                color="secondary"
                onClick={lastItem ? () => onCloseAndReset(true) : next}
              >
                {lastItem ? `Finish` : `Next`}
              </Button>
            </div>
          </div>
        )}
